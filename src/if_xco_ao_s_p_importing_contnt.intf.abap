INTERFACE if_xco_ao_s_p_importing_contnt
  PUBLIC.
  ...
  TYPES:
    BEGIN OF ts_content,
      ...
      preferred_indicator     TYPE abap_bool,
      default_value           TYPE string,
    END OF ts_content.
  DATA importing_parameter TYPE REF TO if_xco_ao_s_p_importing READ-ONLY.
  ...
  METHODS get_pass_by_value_indicator
    IMPORTING
      !io_origin TYPE REF TO cl_xco_ao_origin OPTIONAL
    RETURNING
  ...
  METHODS get_optional_indicator
    IMPORTING
      !io_origin TYPE REF TO cl_xco_ao_origin OPTIONAL
    RETURNING
      VALUE(rv_optional_indicator) TYPE abap_bool.
  METHODS get_preferred_indicator
    IMPORTING
      !io_origin TYPE REF TO cl_xco_ao_origin OPTIONAL
    RETURNING
      VALUE(rv_preferred_indicator) TYPE abap_bool.
