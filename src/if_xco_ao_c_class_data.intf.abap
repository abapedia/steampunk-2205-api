INTERFACE if_xco_ao_c_class_data
  PUBLIC.

  INTERFACES if_xco_printable.

  TYPES:
    list TYPE STANDARD TABLE OF REF TO if_xco_ao_c_class_data WITH DEFAULT KEY.
  ...
  METHODS content
    IMPORTING
      !io_version TYPE REF TO cl_xco_ao_version OPTIONAL
    RETURNING
      VALUE(ro_content) TYPE REF TO if_xco_ao_c_class_data_content.
ENDINTERFACE.