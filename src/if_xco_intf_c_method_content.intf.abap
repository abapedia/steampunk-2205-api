INTERFACE if_xco_intf_c_method_content
  PUBLIC.
  ...
  DATA method TYPE REF TO if_xco_intf_c_method READ-ONLY.
  ...
  METHODS get_default_ignore_indicator
    IMPORTING
      !io_origin TYPE REF TO cl_xco_ao_origin OPTIONAL
    RETURNING
      VALUE(rv_default_ignore_indicator) TYPE abap_bool.
  METHODS get_default_fail_indicator
    IMPORTING
      !io_origin TYPE REF TO cl_xco_ao_origin OPTIONAL
    RETURNING
