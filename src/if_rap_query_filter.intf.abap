INTERFACE if_rap_query_filter
  ...
  METHODS get_as_ranges
    IMPORTING
      !iv_drop_null_comparisons TYPE abap_bool DEFAULT abap_false
    RETURNING
      VALUE(rt_ranges) TYPE tt_name_range_pairs
    RAISING
      cx_rap_query_filter_no_range.
  METHODS get_as_sql_string
    RETURNING
      VALUE(rv_string) TYPE string.
  METHODS get_as_tree
    RETURNING
      VALUE(ro_tree) TYPE REF TO if_rap_query_filter_tree.
ENDINTERFACE.